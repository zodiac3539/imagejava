...
public class JustResize {
	...
	public JustResize() {
		...
		try {
			...
			for(int i=1;i<=25;i++) {
				...
				BufferedImage bi = ImageIO.read(new File(folder + "1151_0"+convention+".jpg"));
	...
	public BufferedImage crop(BufferedImage src, Rectangle rect) throws Exception
	{
	    ...
	    //I can't explain this but you have to draw pictures from -(y-x)
	    //Otherwise, the picture becomes ugly.
